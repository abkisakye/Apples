...
@section('content')
    ...
    <div class="page-head">
        ...
        <div class="actions">
            ...
            <a href="{{ route('reports.consolidated-sales-detail', ['date_from' => $fromDate, 'date_to' => $toDate]) }}" class="button-link">Consolidated Sales Detail</a>
            ...
            <a href="{{ route('reports.product-unit-fix-workbench') }}" class="button-link">Product Unit Setup / Price & Conversion Workbench</a>
