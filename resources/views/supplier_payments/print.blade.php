    ...
    <div class="page">
        ...
        <table class="content">
            <tr>
                <td>
                    <div class="panel">
                        <span class="panel-title">Paid To</span>
                ...
                <td>
                    <div class="panel">
                        ...
                        <table class="summary-table">
                            ...
                            <tr><td>Purchase Total</td><td>{{ $currency }} {{ number_format((float) ($payment->purchase?->total_amount ?? 0), 0) }}</td></tr>
                        </table>
                    </div>
                </td>
            </tr>
        ...
        <table class="content content-1">
            <tr>
                <td>
                    <div class="panel">
                        <span class="panel-title">Accounts Note</span>
                        <div class="detail-copy">
                            This confirms that {{ $currency }} {{ number_format((float) $payment->amount, 0) }} was paid to {{ $payment->supplier?->name ?? 'the supplier' }} and applied to purchase {{ $payment->purchase?->purchase_no ?? '-' }}.
                            @if ($payment->remarks)
