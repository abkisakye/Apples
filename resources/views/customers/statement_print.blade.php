    ...
    <div class="page">
        <table class="header">
            <tr>
                ...
                <td class="doc-block">
                    ...
                    <div class="doc-name">{{ $customer->name }}</div>
                    <div class="doc-meta">
        ...
        <table class="overview">
            <tr>
                ...
                <td>
                    ...
                    <div class="note-copy">Use this statement to follow up credit sales and posted customer payments.</div>
                </td>
            </tr>
        </table>
        ...
        <table class="content">
            <tr>
                <td>
                    <div class="panel">
                        <span class="panel-title">Customer Profile</span>
                        <div class="profile-name">{{ $customer->name }}</div>
                        <div class="profile-line">{{ $customer->phone ?: 'No phone on record' }}</div>
                        <div class="profile-line">{{ $customer->location ?: ($customer->address ?: '-') }}</div>
                    </div>
                </td>
                <td>
                    <div class="panel">
                        ...
                        <table class="summary-table">
                            ...
                            <tr><td>Credit Sales</td><td>{{ $currency }} {{ number_format($summary['total_sales'], 0) }}</td></tr>
